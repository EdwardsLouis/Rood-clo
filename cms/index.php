...
?>          
            ...
            <?php foreach($query as $article){ ?>
                    <img src="images/<?php echo $article["article_img"]; ?>" alt="" onclick="location.href='articulo.php?id=<?php echo $article['article_id'];?>'" class="four columns" style="margin: 0; cursor: pointer; height: 44%;">
            <?php } ?>
                </span>
            </div>
        </div>
