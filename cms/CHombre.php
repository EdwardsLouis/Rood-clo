...
<div class="row">
    ...
    <div class="twelve columns" style="margin-bottom: 30px;">
        ...
        <span class="twelve columns" style="margin-bottom: 20px;">
            <span class="slider">
                ...
                <?php 
                $query = $pdo->query("SELECT article_id, article_img, article_genero, article_categoria FROM articles WHERE article_genero = 'Hombre' AND article_categoria = 'Playera' ORDER BY article_id DESC LIMIT 3");
                foreach($query as $article){ 
                ?>
                    <img src="images/<?php echo $article["article_img"]; ?>" alt="" onclick="location.href='articulo.php?id=<?php echo $article['article_id'];?>'" class="four columns" style="margin: 0; cursor: pointer; height: 100%;">
                <?php } ?>
                </span>
                <span class="ssslider" style="height: 300px;">
                <?php 
                $query = $pdo->query("SELECT article_id, article_img, article_genero, article_categoria FROM articles WHERE article_genero = 'Hombre' AND article_categoria = 'Playera' ORDER BY article_id DESC LIMIT 4,6");
                foreach($query as $article){ 
                ?>
                    <img src="images/<?php echo $article["article_img"]; ?>" alt="" onclick="location.href='articulo.php?id=<?php echo $article['article_id'];?>'" class="four columns" style="margin: 0; cursor: pointer; height: 100%;">
                <?php } ?>
    ...
    <div class="twelve columns" style="margin-bottom: 30px;">
        ...
        <span class="twelve columns" style="margin-bottom: 20px;">
            ...
            <span class="ssslider" style="height: 300px;">
                <?php 
                $query = $pdo->query("SELECT article_id, article_img, article_genero, article_categoria FROM articles WHERE article_genero = 'Hombre' AND article_categoria = 'Sudadera' ORDER BY article_id DESC LIMIT 3");
                foreach($query as $article){ 
                ?>
                    <img src="images/<?php echo $article["article_img"]; ?>" alt="" onclick="location.href='articulo.php?id=<?php echo $article['article_id'];?>'" class="four columns" style="margin: 0; cursor: pointer; height: 100%;">
                <?php } ?>
                ...
                <span class="ssslider" style="height: 300px;">
                <?php 
                $query = $pdo->query("SELECT article_id, article_img, article_genero, article_categoria FROM articles WHERE article_genero = 'Hombre' AND article_categoria = 'Sudadera' ORDER BY article_id DESC LIMIT 4,6");
                foreach($query as $article){ 
                ?>
                    <img src="images/<?php echo $article["article_img"]; ?>" alt="" onclick="location.href='articulo.php?id=<?php echo $article['article_id'];?>'" class="four columns" style="margin: 0; cursor: pointer; height: 100%;">
                <?php } ?>
