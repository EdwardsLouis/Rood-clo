    ...
    <div class="twelve columns" style="margin-bottom: 30px;">
        ...
        <span class="twelve columns" style="margin-bottom: 20px;">
            <span class="slider">
                ...
                <?php 
                $query = $pdo->query("SELECT article_id, article_img, article_genero, article_categoria FROM articles WHERE article_genero = 'Mujer' AND article_categoria = 'Playera' ORDER BY article_id DESC LIMIT 3");
